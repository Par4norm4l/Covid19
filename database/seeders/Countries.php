...
class Countries extends Seeder
{
    ...
    public function run()
    {
        ...
        $countries = array(
            array('name' => 'Afghanistan TodayCases:48', 'code' => 'AFG'),
            array('name' => 'Albania TodayCases:0', 'code' => 'ALB'),
            array('name' => 'Algeria TodayCases:0', 'code' => 'DZA'),
            array('name' => 'American Samoa TodayCases:0', 'code' => 'ASM'),
            array('name' => 'Andorra TodayCases:0', 'code ' => 'AND'),
            array('name' => 'Angola TodayCases:0', 'code' => 'AGO'),
            array('name' => 'Anguilla TodayCases:0', 'code' => 'AIA'),
            array('name' => 'Antarctica TodayCases:0', 'code' => 'ATA'),
            array('name' => 'Antigua and Barbuda TodayCases:0', 'code' => 'ATG'),
            array('name' => 'Argentina TodayCases:0', 'code' => 'ARG'),
            array('name' => 'Armenia TodayCases:3536', 'code' => 'ARM'),
            array('name' => 'Aruba TodayCases:0', 'code' => 'ABW'),
